...
<c:url var="logoutAction" value="/logout"></c:url>
	...
	<style>
		...
		<div class="col col-md-offset-2 col-md-7" style="margin-left:500px; ">
			<div class="row">
				<h1 id="containers" style="margin-left: 50px;"><u>New User Addition Form</u></h1>
		</div>
		<form action="C:/Users/ACER/Desktop/sms/adminHome.html" method="post">
			...
			<div class="row">
					...
					<label for="flatNo" required="required">Select Flat No:</label>
					  		<select class="form-control" id="flatNo"  required="required">
					    		<option>1</option>
					    		<option>2</option>
					    		<option>3</option>
					    		<option>4</option>
            ...
            <div class="row">
					...
					<div class="form-group"> 
						<label for="block">Select Block No:</label>
					  		<select class="form-control" id="block" required="required">
					    		<option>A</option>
					    		<option>B</option>
					    		<option>C</option>
					    		<option>D</option>
					...
					<div class="form-group">
							<label for="block">Select Floor No:</label>
					  		<select class="form-control" id="floor"  required="required">
					    		<option>1</option>
					    		<option>2</option>
					    		<option>3</option>
					    		<option>4</option>
            ...
            <div class="row">
					<div class="col-md-4">
					<div class="form-group">
							<label for="flatType" required="required">Select Flat Type:</label>
